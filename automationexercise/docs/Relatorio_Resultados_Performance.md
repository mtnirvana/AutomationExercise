...
| **Script** | `Cypress/cypress/e2e/performance/TC_PF_008_core_web_vitals.cy.js` |
| **Status** | ✅ **APROVADO** |
...
| Arquivo | Conteúdo |
|:--------|:---------|
| `Cypress/cypress/reports/k6/TC_PF_001_smoke_test.json` | Métricas do smoke test em JSON |
...
| `Cypress/cypress/e2e/performance/TC_PF_001_smoke_test.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_002_carga_homepage.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_003_carga_api_produtos.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_004_carga_api_login.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_005_estresse_api_produtos.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_006_resistencia_soak.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_007_pico_spike.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_009_carga_checkout.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_011_carga_atualizar_conta.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_012_carga_detalhes_usuario.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_013_carga_pesquisar_produto.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_014_carga_pagina_produtos.js` | Script executado |
| `Cypress/cypress/e2e/performance/TC_PF_008_core_web_vitals.cy.js` | Teste Cypress TC_PF_008 |
