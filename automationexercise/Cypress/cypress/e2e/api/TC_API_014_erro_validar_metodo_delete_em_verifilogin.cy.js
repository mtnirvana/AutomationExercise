 ...
 * @description Validar que DELETE não é suportado em /api/verifyLogin
 * @tags @erro @TC_API_014
 * @author Rafael Barelli
 */

describe('TC_API_014 - Validar método DELETE em verifyLogin via API', () => {
  const testId = 'TC_API_014'

  it('deve retornar erro 405 quando DELETE é usado em verifyLogin', () => {
    // 1. Enviar requisição DELETE para /api/verifyLogin
    cy.task('apiRequest', {
      ...
      cy.task('generateEvidenceReport', {
        testId,
        testName: 'Validar método DELETE em verifyLogin via API',
