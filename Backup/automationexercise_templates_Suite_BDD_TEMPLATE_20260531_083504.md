...
>
> ¹ Os cenários classificados como "Erro" na performance (ex: TC_PF_003, TC_PF_005) são Limitação de Rate Limiting do Cloudflare, não erros funcionais. Os thresholds foram ajustados para tolerar a degradação esperada sob carga.
