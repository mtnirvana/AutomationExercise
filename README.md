...
1. **📚 Contextualizar** — Usa o handoff da etapa anterior para guiar a leitura seletiva do projeto: governança (`AGENTS.md`), padrões (`Guia_Cypress_Template.md`), templates de documentação, Page Objects, base de seletores (`Seletores.md`) e dados disponíveis (`fixtures/` + `UserFactory`)
